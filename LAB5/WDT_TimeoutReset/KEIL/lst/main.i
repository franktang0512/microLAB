    ...
    if(((((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR & (1ul << 3))? 1 : 0) == 1)
    {
        ...
        printf("Watch Dog Time-out Interrupt is taking place.\n");
				...
				else if(state%2==1)
				{
						...
						((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->PMD = 0xFFFFFFFD;
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK = (1ul << 16) | (1ul << 0);

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (0x1UL<<24) | (0x3UL<<0);
...
int main(void)
{
    ...
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->IMD |= (0UL << 2);
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->IEN |= (0x00000004 << 16);
    NVIC_EnableIRQ(GPAB_IRQn);

     
    ((GPIO_DBNCECON_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0180))->DBNCECON = ((1ul << 5) | 0x00000010UL | 0x0000000AUL);
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->DBEN |= (0x00000008 | 0x00000004);
    ...
    ((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR = (5UL << 8) | (1ul << 6) | (1ul << 1) | (1ul << 7);
